...
\newcommand{\orientador}{Prof.$^a$ Cibele Queiroz da Silva, Ph.D.}
\newcommand{\mes}{Junho}
\newcommand{\ano}{2015}
\newcommand{\defesa}{18 de Junho de 2015}
...
\newenvironment{comentario}{\vspace{0.5cm}\noindent\textcolor{red}{\textit{\underline{Comentário}}}\vspace{0.2cm}\newline}{\newline\strut\hfill$\blacksquare$\vspace{0.2cm}}

%Define BUGS Language
...
\setcounter{page}{1}
<<review, child = paste("./partes", list.files("./partes", pattern = "^[0-9]"), sep = "/")>>=
@
